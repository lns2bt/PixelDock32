...
DEFAULT_MODULES = [
    {"key": "clock", "name": "Clock", "sort_order": 0, "duration_seconds": 8, "settings": {"timezone": "Europe/Vienna"}},
    {"key": "btc", "name": "BTC EUR", "sort_order": 1, "duration_seconds": 10, "settings": {}},
    {"key": "weather", "name": "Weather Innsbruck", "sort_order": 2, "duration_seconds": 10, "settings": {"postcode": "6020"}},
]
