...
class DisplayService:
    ...
    def set_manual_text(self, text: str, seconds: int, font_size: str = "normal"):
        self.manual_override = (render_text_frame(text, font_size=font_size), time.time() + seconds)
    ...
    async def _get_next_frame(self) -> tuple[list[list[int]], list[list[tuple[int, int, int] | None]]]:
        ...
        frame = payload.frame or render_text_frame(payload.text, font_size=payload.font_size)
